 ...
 * Teacher: Mr. Ho
 * Description: Flashcards Final Project to get that A+
 */
...
public class flashcardsCode extends Application {
   ...
   // start method will become the new "main" method, so all the codes is able to
   // work together
   @Override
   ...
   /**
    * @author Cynthia Lei Responsible for coding the components of the menu
    * @author Johnny He Responsible for styling the menu Displays the menu GUI
    * 
    * @author Daiphy Lee Responsible for adding instructions
    * @author Sophia Nguyen Responsible for setting up manual input scene
    * 
    ...
    * @param answersArrList   arraylist that contains all the answers that
    *                         correspond to the questions in questionsArrList
    * @param arrIndex         this tracks which question number and answer the
    *                         flashcards GUI should display
   ...
   /**
    * @author Sophia Nguyen Setting background image for flashcards scene
    * 
    * @return background that will be used if program can find the image, it will
    *         use a flashcard background if not, it will set the colour to default grey
    */
   ...
   /**
    * 
    * @author Sophia Nguyen Setting up the manual input scene and checking to sure
    *         there are questions and answers before adding to arrays
    * 
   ...
   public Scene sceneManualInputText(Stage primaryStage, ArrayList<String> questionsArr, ArrayList<String> answersArr, int[] arrIndex, int width, int height) {
      ...
      submit.setFont(font);
      // Creating a button for users to view their flashcards after they inputted all
      // their questions
      Button finish = new Button("Finished Inputting");
      finish.setFont(font);
      // Error text to force users to input both a question and answer before
      // submitting
      Text error = new Text("");
      ...
      submit.setOnAction(action -> {
         ...
         // If the question text field is empty, program does not let user submit and
         // prompts them for a question
         if (questionString.equals("")) {
            error.setText("Please input a question.");
         }
         // If the answer text field is empty, program does not let user submit and
         // prompts them for an answer
         else if (answerString.equals("")) {
            error.setText("Please input an answer.");
         }
         // If the question text field and answer text field both have an answer, program
         // adds the string from the textfields into the array
      ...
      // When the user is done inputting all of their questions and answers they would
      // hit submit
   ...
   /**
    * @author Daiphy Lee Shows the instructions when the user presses the
    *         'Instructions' button. Allows user to return to the Menu scene to
    *         choose one of the options to create the flash cards
    *
    * @param primaryStage     The "base" of this GUI. It hosts all the scenes.
    * @param width            the width of the menu GUI scene
    * @param height           the width of the menu GUI scene
   ...
   /**
    * @author Daiphy Lee Button that returns user to the main menu as well as
    *         delete past user inputs for the questions and answers in the
    *         arrayList
    *
    * @param primaryStage     The "base" of this GUI. It hosts all the scenes.
    * @param width            the width of the menu GUI scene
   ...
   /**
    * @author Cynthia Lei Checks whether the inputted file is .txt or .csv
    * 
    * @param primaryStage     The "base" of this GUI. It hosts all the scenes.
    * @param questionsArrList arraylist that contains all the questions
    * @param answersArrList   arraylist that contains all the answers that
   ...
   /**
    * @author Cynthia Lei Responsible for creating the method itself, assigning the
    *         parameters
    * @author Johnny He Responsible for creating the content/code inside the method
    *         JOHNNY ADD COMMENTS AND/OR FORMATTING FOR UR CODE ERASE THIS COMMENT
    *         ALSO This method displays the flashcards GUI
    * 
    * @param questionsArrList arraylist that contains all the questions
    * @param answersArrList   arraylist that contains all the answers that
    *                         correspond to the questions in questionsArrList
    ...
    * @return the flashcards scene with all the necessary components (questions &
    *         answers, buttons etc.)
    */
    ...
    *         Determine the total number of lines in the given file. This is so we
    *         can initialize arrays the size of the total file lines
    * 
   ...
   /**
    * @author Cynthia Lei Reads the .txt file by identifying the question and
    *         answer portion of each line. Then it will sort the question and
    *         answer strings into their respective arrays
    * 
   ...
   public static void readTxtFile(String fullFilePath, ArrayList<String> questionsArrList, ArrayList<String> answersArrList) {
      ...
      String realQuestion = "";
      String realAnswer = "";
      int lineNum = 0; // tells us the index of the element to populate for the question and answer
                       // arrays
   ...
   /**
    * @author Cynthia Lei Stores the question as a string from .txt file
    *
   ...
   /**
    * @author Cynthia Lei Stores the answer as a string from .txt file
    * 
    * @param txtLine         this line from the .txt will be read
    * @param questionMarkLoc the index of the question mark in the line
   ...
   /**
    * @author Cynthia Lei Determining whether it is necessary to add a placeholder.
    ...
    * @param element   the question or answer string that is to be added into the
    *                  questions or answers array respectively
    */
   ...
   /**
    * @author Daiphy Lee Reads CSV file using CSVReader. Automatically splits the
    *         information using it's delimeter. Differentiates the questions from
    *         the answers and puts them into its own array.
    *
   ...
   /**
    * @author Daiphy Lee Uses Modulus to determine the even lines which are the
    *         lines containing the questions
    *
    * @param totalLines the total number of lines in the CSVFile
    * @return the even line number until there are no more lines with data; if
    *         there are no even lines it'll return -1
    */
   ...
   /**
    * @author Daiphy Lee Uses Modulus to determine the odd numbered lines which are
    *         the lines containing the questions
    *
    * @param totalLines the total number of lines in the CSVFile
    * @return the odd line number until there are no more lines with data; if there
    *         are no odd lines it'll return -1
    */
